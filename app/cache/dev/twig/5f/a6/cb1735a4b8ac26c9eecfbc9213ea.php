...
class __TwigTemplate_5fa6cb1735a4b8ac26c9eecfbc9213ea extends Twig_Template
{
...
<script type=\"text/javascript\">/*<![CDATA[*/
    var sf2gen = {
        ...
        commands: ";
        // line 13
        echo json_encode($this->getContext($context, 'commands'));
        echo ",
        selectedCommand: -1,
        init: function(){
            ...
            xhr.open('GET', '";
        // line 18
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_sf2gencdt"), "html");
        echo "', false);
            xhr.send('');
        ...
        request: function(txt){
            ...
            xhr.open('POST', '";
        // line 56
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_sf2gencdt_request"), "html");
        echo "', true);
        ...
        console: function(e) {
            ...
            if(keynum == 13 && this.input.value.length > 0){
