...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Quiz\\QuizBundle\\Controller\\DefaultController::indexAction',  '_route' => 'homepage',);
        }

        // init
        if ($pathinfo === '/init') {
            return array (  '_controller' => 'Quiz\\QuizBundle\\Controller\\InitController::importRubriquesAction',  '_route' => 'init',);
        }
